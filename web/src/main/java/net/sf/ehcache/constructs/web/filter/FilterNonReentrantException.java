...
/**
 * Thrown when it is detected that a caching filter's {@link CachingFilter#doFilter(jakarta.servlet.ServletRequest, jakarta.servlet.ServletResponse, jakarta.servlet.FilterChain)}
 ...
 * or programmatically when a {@link jakarta.servlet.RequestDispatcher} includes or forwards back to the same URL,
